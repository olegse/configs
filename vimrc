...
" Register directly in yaml properties can be done like this:et @p='·'
let @b='</br>'
...
" Good! Attempt to enter next input
"map <S-i>    /=\"<Return>f"a
...
"set background=dark
"colorscheme default
"highlight IncSearch ctermbg=black  ctermfg=lightgrey
"highlight Search ctermbg=black  ctermfg=white

so ~/.vim/autoload/mappings.vim
